...
public class DozeSettingsFragment extends SettingsBasePreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (DozeUtils.DOZE_ENABLE.equals(preference.getKey())) {
            ...
            DozeUtils.enableGesture(getActivity(), preference.getKey(), isChecked);
        } else if (DozeUtils.WAKE_ON_GESTURE_KEY.equals(preference.getKey())) {
            mWakeOnGesturePreference.setEnabled(isChecked);
        } else if (DozeUtils.GESTURE_PICK_UP_KEY.equals(preference.getKey())) {
            mPickUpPreference.setEnabled(isChecked);
        } else if (DozeUtils.GESTURE_HAND_WAVE_KEY.equals(preference.getKey())) {
            mHandwavePreference.setEnabled(isChecked);
        } else if (DozeUtils.GESTURE_POCKET_KEY.equals(preference.getKey())) {
