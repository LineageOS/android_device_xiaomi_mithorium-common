...
include $(CLEAR_VARS)
_version := 1.0
_sed_pattern := "s|$(_frontend_hidl_package_name)@$(_version)::$(_frontend_hidl_interface_name)|$(_backend_hidl_package_name)@$(_version)::$(_backend_hidl_interface_name)|g;s|$(_frontend_hidl_package_name)@$(_version)\.so|$(_shim_hidl_library_name)@$(_version).so|g"
